 ...
 */
public class SAutoImageView extends ImageButton {

    public SAutoImageView(Context context) {
        super(context);
    }

    public SAutoImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SAutoImageView(Context context, AttributeSet attrs, int defStyle) {
