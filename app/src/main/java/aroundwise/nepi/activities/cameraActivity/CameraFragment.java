...
import aroundwise.nepi.util.AutoFitTextureView;
...
public class CameraFragment extends BaseFragment implements FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    Callback callback = new Callback() {
        @Override
        public void callbackHideDialog() {
    ...
    protected void setUpViews() {
        if (!imageRoot.exists())
            imageRoot.mkdir();
        if (mFile == null)
            mFile = new File(imageRoot, System.currentTimeMillis() + ".jpg");
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener
        ...
        public void onImageAvailable(ImageReader reader) {
            mBackgroundHandler.post(new ImageSaver(reader.acquireNextImage(), mFile, getActivity(), callback));
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode == CAMERAREQUEST
            ...
            builder.setTitle("Permisiuni necesare!")
                    .setMessage("Pentru a utiliza opțiunea de scanează bon este necesar acordul d-voastra pentru a utiliza camera și spațiul de stocare!")
    ...
    private static class ImageSaver implements Runnable {
        ...
        public ImageSaver(Image image, File file, Context context, Callback callback) {
            mImage = image;
            mFile = file;
            mContext = context;
            mCallback = callback;
    ...
    public boolean askForCamerPermssion() {
        ...
        ocrClient.scanReceiptCall(Session.getUser().getUserProfileId(),
                ...
                .subscribe(new Action1<OCRResponse>() {
                    ...
                    public void call(Throwable throwable) {
                        ...
                        Toast.makeText(getActivity(), "A apărut o eroare. Vă rugăm șă mai trimiteți o data!", Toast.LENGTH_SHORT).show();
                        hideProgressDialog();
                    }
                }, new Action0() {
                    @Override
                    public void call() {
                        Toast.makeText(getActivity(), "Mulțumim! Revenim în maximum 24 de ore.", Toast.LENGTH_LONG).show();
                        android.support.v7.app.AlertDialog.Builder builder = new android.support.v7.app.AlertDialog.Builder(getActivity());
